...
namespace FinalFcp.Controllers
{
  //  [Authorize]
    public class SeriesController : Controller
    {
        ...
        public SeriesController(FinalFcpContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            return _context.Series != null ?
                        ...
                        Problem("Entity set 'FinalEjbcContext.Series'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'FinalFcpContext.Series'  is null.");
            }
            var serie = await _context.Series.FindAsync(id);
            if (serie != null)
            {
