...
using FinalFcp.Controllers;
using FinalFcp.Models;
...
namespace FinalFcp.Controllers
{
    public class AccountController : Controller
    {
        private readonly FinalFcpContext _context;

        public AccountController(FinalFcpContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Login(LoginViewModels model, string? returnUrl = null)
        {
            ...
            var usuario = _context.Usuarios.Where(x => x.RegistroActivo == true && x.Usuario1 == model.usuario && x.Clave == model.clave).FirstOrDefault();
